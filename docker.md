...
## App Dockerfile: container, services, and stack, from low to high

Check the folder webapp. Inside the folder, there are three files needed to build the wbe app.
